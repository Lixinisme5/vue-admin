<template>
  <div id="table">
    ...
    >
      ...
      <!-- 投资时间 -->
      <el-table-column label="投资时间" align="center" width="150px">
        <template slot-scope="scope">
          <span>
      ...
      <!-- 收支类型 -->
      <el-table-column label="收支类型" align="center" width="130px">
        <template slot-scope="scope">
          {{ payTypeObj[scope.row.payType] }}
        </template>
      </el-table-column>
      <!-- 收入 -->
      <el-table-column label="收入" align="center" width="100px">
        <template slot-scope="scope">
      ...
      <!-- 支出 -->
      <el-table-column label="支出" align="center" width="100px">
        <template slot-scope="scope">
      ...
      <!-- 账户现金 -->
      <el-table-column label="账户现金" align="center" width="100px">
        <template slot-scope="scope">
